...
PROM_TARGET_ENDPOINT = os.environ.get(
        'PROM_TARGET_ENDPOINT',
        'http://server-prom.marathon.mesos:9090/targets')
REGISTRY.unregister(PROCESS_COLLECTOR)
REGISTRY.register(PromTargetCollector(PROM_TARGET_ENDPOINT))
app = Flask(__name__)
